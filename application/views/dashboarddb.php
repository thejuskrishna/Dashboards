          ...
          <!-- TO DO List -->
           ...
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <a href="<?php echo base_url() .'index.php/home_cont/show_graph/'.$table.'/'.$id ?>" class="pull-right" style="color: black;">
                   <button type="button" class="pull-right">
                    <i class="fa fa-minus-circle " style="color: black"></i>showgraph
                                       </button></a>
