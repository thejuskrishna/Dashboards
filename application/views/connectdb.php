    ...
    <section class="content-header">
       ...
       <!-- <div class="container">-->
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="login-panel panel panel-default" style="width: 400px;">
                    <div class="panel-heading">
                        <h3 class="panel-title">Connect Database</h3>
                    </div>
                     <?php echo validation_errors();?>
                        <?php echo form_open(base_url().'index.php/home_cont/checkconnect'); ?>
                        <div class="">
