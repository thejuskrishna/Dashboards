  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo base_url();?>index.php/home_cont/homeview">
          ...
          <!-- TO DO List -->
           ...
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <a href="<?php echo base_url() .'index.php/home_cont/table_delete/'.$table.'/'.$id ?>" class="pull-right" style="color: black;">
                   <button type="button" class="pull-right">
                    <i class="fa fa-minus-circle " style="color: black"></i>Drop
                                       </button></a>
              
              <a href="<?php echo base_url() .'index.php/home_cont/insertfield/'.$table ?>" class="pull-right" style="color: black;">     
                    <button type="button " class="pull-right" > 
